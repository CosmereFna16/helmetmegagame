...
async function syncNarrowcastChannels(prisma) {
  ...
  for (const entry of CHANNELS) {
    ...
    // @everyone is denied both by default; per-character access is granted
    // separately as tags/location change.
    await putChannelOverwrite(newChannelId, guildId, { deny: PERM_VIEW_CHANNEL | PERM_SEND_MESSAGES });
