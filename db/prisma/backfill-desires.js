...
// rows (poppy-habit, glutton, cruel, death-wish-interest) exist;
...
const CONVERSIONS = [
  ...
  // blood-debt -> blood-feud was removed 2026-09-02. The sign-off pass deleted
  // the blood-feud tag entirely, and sync-tags is upsert-only so it will never
  // be recreated — this conversion would have targeted a slug that does not
  // exist. blood-debt joins honorbound in FREE_REMOVAL_SLUGS below instead:
  // both were "absorbed into blood-feud", and with no blood-feud to absorb
  // into, the honest outcome is that the legacy tag simply comes off the sheet.
...
const FREE_REMOVAL_SLUGS = ["squeamish", "cheap", "honest", "addiction-romantic", "honorbound", "blood-debt"];
