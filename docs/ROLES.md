...
Manor Lord
- Live in your Manor in the hills, enjoy your wine, participate in court politics.
- difficulty: easy
- leader: false
- starting tag: Wealthy
- doc elements: courtier
...
Cult of Bacchus (Leader, Cultist)
...
- difficulty: difficult
- leader: true (for the Leader; false for Cultists)
...
- Roles: Brigand Leader, Brigand.
- difficulty: medium
- leader: true (for the Brigand Leader; false for Brigands)
