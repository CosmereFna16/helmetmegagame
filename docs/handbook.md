...
Bascinet is an online megagame played across Discord and the website, found [here](https://ravenheart.quest/). You will spend most of your time in Discord, where you interact with the game world and other players. The website holds various game tools such as your character details, the world map, and documents about the world.

## How Do I Play?

### Turn Overview
Each part of the game is explained in detail later in this Handbook. At a high level, the day-to-day gameplay is fairly simple:

**Review The Move Results**  
...
Walk between Locations (on a short cooldown), travel to another Zone, submit a description of what your character is trying to accomplish this turn, or do neither and allow your Default Move to occur.
...
| Page | Content |
|---|---|
| **Character** | Your character sheet. Current Location, Resources, Gambit modifier, Tag Points, tags and equipment, Desires, Default Move, your bio and portrait, and all usable actions. |
...
- **Travel** Moves you to a connected area. Walking between Locations inside your Zone is free, with a short cooldown between steps. Crossing into another Zone costs a Move, but can be done twice with a mount. You arrive immediately, and are able to bring along anyone you could carry: someone bound or helpless, a body, or a member of your faction if you lead it. 
...
At this point there are a few recommended next steps:
...
- You ask around publicly for others to help solve it, or invite specific people you trust into a Private thread to discuss.
- You collectively agree on a plan.
- Each of you submits a Move describing what your character is doing to accomplish your part in that plan.
- When the turn ends, the Move resolution is posted and you discover its consequences.

Keep in mind that submitting a Move doesn't end your ability to speak and interact with others.
...
Every Zone is made of Locations, e.g. the Gatehouse, the Keep and the Garrison in the Fortress. Your character stands in exactly one Location at a time, and sees only that Location's channel and its Rooms (plus the Zone's Summary). Locations are connected like a map: use **Travel** to walk to a neighbouring one. 
...
- **Important:** Roleplaying outside of the server or in DMs is not allowed. If it didn't happen inside the Bascinet server, then it didn't happen at all.
...
You can interact with messages posted in roleplay channels by adding a Reaction. The bot will process the reaction, remove it from the message, and provide you the result.
...
| **Move Player** | Carry a dead or bound person, or a member of your faction if you're the Leader, to a connected Location. This doesn't spend their Move or yours. The Travel picker on Discord offers this option as well. | Always. |
